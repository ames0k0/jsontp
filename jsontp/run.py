import json
from typing import Optional, Union, NoReturn, Generator
...
class PageDataTree:
    ...
    def process_result(
        self, result: str, result_to: str, result_value: str
    ...
    def data_by_tree(self, tree: str) -> dict:
        if Tree.ROOT:
            tree = tree.replace(self.join_tree(Tree.ROOT, ""), "", 1)
